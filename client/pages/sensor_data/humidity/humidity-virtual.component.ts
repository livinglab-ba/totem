...
@Component({
    selector:'humidity-virtual',
    template: require('./humidity-virtual.component.html')
})

/**
 * View class for virtual humidity sensor data
 */
export class VirtualHumidityComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		this.data = 0;
		this.subscription = this.listenerService.listenToVirtualHumidityMessages()
