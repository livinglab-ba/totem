...
@Component({
    selector:'temperature-real',
    template: require('./temperature-real.component.html')
})

/**
 * View class for real temperature sensor data
 */
export class RealTemperatureComponent implements OnInit, OnDestroy {
	...
	ngOnInit() {
		this.data = 0;
		this.subscription = this.listenerService.listenToRealTemperatureMessages()
